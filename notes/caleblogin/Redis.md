...
- [Redis](#redis)
  ...
  - [Memcached VS Redis](#memcached-vs-redis)
    ...
    - [区别](#区别)
  - [扩展](#扩展)
    - [假如Redis里面有1亿个key，有10wkey是以某个固定前缀开头，如何全部找出？](#假如redis里面有1亿个key有10wkey是以某个固定前缀开头如何全部找出)
    - [如果redis正在给线上的业务提供服务，那使用keys指令会有什么问题？](#如果redis正在给线上的业务提供服务那使用keys指令会有什么问题)
