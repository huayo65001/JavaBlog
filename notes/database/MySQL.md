...
- 存储引擎
    ...
    - 比较
        ...
        6. MVCC：InnoDB支持。应对高并发事务, MVCC比单纯的加锁更高效;MVCC只在 RC 和 RR 两个隔离级别下工作;MVCC可以使用 乐观(optimistic)锁 和 悲观(pessimistic)锁来实现；各数据库中MVCC实现并不统一。
...
- MySQL的可重复怎么实现的
    ...
    **未完，接着写**https://zhuanlan.zhihu.com/p/150089208
